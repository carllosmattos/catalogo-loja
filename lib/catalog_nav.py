"""Navegação do catálogo público — sidebar nativa (colapsável como admin)."""
...
def render_catalog_nav(
    ...
    *,
    ...
    """Navegação na sidebar lateral com colapso nativo do Streamlit."""
    ...
    st.markdown(
        f'<p class="catalog-section-title">{html.escape(current_label)}</p>',
